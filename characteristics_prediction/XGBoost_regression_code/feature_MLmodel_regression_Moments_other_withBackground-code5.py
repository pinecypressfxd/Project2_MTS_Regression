...
if __name__ == "__main__":
    ...
    year_start = 2007
    year_end = 2024
    # variables = ['Bx', 'By', 'Bz', 'Ex', 'Ey', 'Ez', 'Ni', 'Ne', 'plasma_beta',
    ...
    # 预测E
    variables_del_V_B = ['Ni', 'Ne', 'Ti', 'Te', 'Pp', 'T_N_ratio', 'Ti_Te_ratio', 'ion_Special_Entropy', 'ele_Special_Entropy',
                         'plasma_beta',
                         'Pos_X', 'Pos_Y', 'Pos_Z'
                         ]
    # 预测Plasmabeta
    variables_del_N_T =  ['Bx', 'By', 'Bz', 'B_total', 'B_inclination', 'Pm', 
                          'Vx', 'Vy', 'Vz', 'Vi_total', 'Vx_prep_B', 'Vy_prep_B', 'Vz_prep_B', 'V_prep_total',
    ...
    artificial_variables = ['Bz', 'Ni', 'Ne', 'Pm', 'Pp', 'Ti', 'Te', 'B_inclination', 'T_N_ratio', 'Pos_X', 'Pos_Y', 'Pos_Z']
     # B
    variables_B = ['B_total','By','Bz','B_total', 'B_inclination','Pos_X', 'Pos_Y', 'Pos_Z']
    variables_Pos = ['Pos_X', 'Pos_Y', 'Pos_Z']
    # Momentum
    variables_Mom = ['Ni', 'Ne', 'plasma_beta','Pm', 'Pp', 
    'Ti', 'Te', 
    # 'Vx_prep_B', 'Vy_prep_B',
    # 'Vz_prep_B', 'V_prep_total',
    'T_N_ratio', 'Pos_X', 'Pos_Y', 'Pos_Z']
    # target_features = ['Max']#['Mean','Max','Min','Range']
    target_features = ['Mean','Max','Min','Range']

    X_variables = variables_del_V_B# variables_del_N_T# 
    target_variables = ['total_flux_transport']
    # unit = '[1/cm^3]'
    # unit = '[keV]'
    # unit = '[mV/m]'
    unit = '[Wb/m]'
    ...
    # print(f'Test set with arctan - mape: {mape_arctan_test}')
