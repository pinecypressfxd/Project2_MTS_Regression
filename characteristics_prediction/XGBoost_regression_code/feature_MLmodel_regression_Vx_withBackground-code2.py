...
if __name__ == "__main__":
    ...
    # 去掉与速度有关的参数
    variables_del_V = ['Bx', 'By', 'Bz', 'B_total', 'B_inclination', 'Pm', 
                       'Ni', 'Ne', 'Ti', 'Te', 'Pp', 'T_N_ratio', 'Ti_Te_ratio', 'ion_Special_Entropy', 'ele_Special_Entropy',
                       'plasma_beta', 'total_flux_transport',
                       'Pos_X', 'Pos_Y', 'Pos_Z']
    variables_del_V_prep_B = [ 
                       'Ni', 'Ne', 'Ti', 'Te', 'Pp', 'T_N_ratio', 'Ti_Te_ratio', 'ion_Special_Entropy', 'ele_Special_Entropy',
                       'plasma_beta', 'total_flux_transport',
                       'Pos_X', 'Pos_Y', 'Pos_Z']
    # 去掉与速度有关的参数
    ...
    # 提取用于预测的变量数据
    X_variables = variables_del_V_prep_B# variables_del_V_prep_B# 
